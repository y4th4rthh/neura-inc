  ...
  return (
    ...
    `}
        ...
        >
          ...
          {/* Main Content */}
          <main className="relative mx-auto max-w-7xl px-1 py-12 sm:px-6 lg:px-8">
            <div className="mb-6 text-center">
              <h2 className="md:text-4xl text-3xl font-bold text-foreground">Experience AI at Lightning Speed</h2>
