...
<footer className="border-t border-border bg-card/50 py-12 px-4">
  <div className="container mx-auto max-w-6xl">
    <div className="grid hidden md:grid-cols-4 gap-8 mb-8">
      <div>
        <div className="flex items-center gap-2 font-bold text-lg mb-4">
          <div className="w-8 h-8 p-2 bg-primary rounded-lg flex items-center justify-center">
            <Zap />
          </div>
          <span style={{ WebkitTextFillColor: 'transparent' , background: 'linear-gradient(135deg, #fff, #ff6b00)' ,
            WebkitBackgroundClip: 'text' , backgroundClip: 'text' , fontSize: '24px' , fontWeight: 700, margin: 0 }}>
            Neura.ai
          </span>
    ...
    <div className="grid grid-rows-2 md:hidden gap-8 mb-8">
      <div>
        <div className="flex items-center gap-2 font-bold text-lg mb-4">
          <div className="w-8 h-8 p-2 bg-primary rounded-lg flex items-center justify-center">
            <Zap />
      ...
      <div className="grid grid-cols-2 md:hidden gap-8 mb-8">
        <div>
          <h4 className="font-semibold text-foreground mb-4">Product</h4>
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>
