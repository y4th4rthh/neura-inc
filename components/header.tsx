          ...
          <div className="px-5 h-full">
            <div className="flex items-center flex-col justify-between gap-6 text-sm font-semibold text-white/80 mb-4 pb-2 h-full">
              ...
              <Button
                ...
                title="Get started"
                className="w-[35px] py-1 px-1 bg-red-500/10 border border-red-500/30 rounded-lg text-red-400 text-sm font-medium hover:bg-red-500/20 hover:border-red-500/50 transition-all duration-200 flex md:hidden items-center justify-center gap-2"
              >
                <Sparkles size={14} />
